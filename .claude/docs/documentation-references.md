...
| File                                      | Contents                                                                                                                                                                                                                                                                                                                               |
| ----------------------------------------- | -------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| `.claude/docs/entity-system.md`           | The mesh → entity → animation chain, three-level lookup, file organisation in `gfx/entities/`, pdxmesh naming convention, division designer performance note. Also covers landmark buildings: state-file placement, `map/buildings.txt` spawn points, `provinces.bmp` validation, heightmap-calibrated y, and common rendering gotchas |
